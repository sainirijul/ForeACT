...
export const CORE_METACLASSES: MetaclassDefinition[] = [
  ...
  },
  {
    ...
    stereotype: "EClass",
    description:
      "Root container for one dataset-specific ForeACT assurance project.",
    attributes: [
    ...
    references: [
      ...
      },
      {
        ...
        target: "ForecastComparisonModel",
        lowerBound: 0,
        upperBound: 1,
        containment: true,
      },
  ...
  },
  {
    ...
    attributes: [{ name: "completenessScore", type: "EDouble" }],
    references: [
      {
        name: "fields",
        target: "SemanticField",
        lowerBound: 1,
        upperBound: "*",
        containment: true,
      },
  ...
  },
  {
    ...
    stereotype: "EClass",
    description:
      "Semantic field identifying forecast cycles or forecast versions.",
    attributes: [{ name: "versionFormat", type: "EString" }],
    references: [],
  },
  {
    id: "HorizonField",
    ...
    stereotype: "EClass",
    description:
      "Semantic field identifying forecast periods or forecast horizons.",
    attributes: [{ name: "granularity", type: "EString" }],
    references: [],
  },
  {
    id: "TargetField",
    ...
    attributes: [{ name: "riskDirection", type: "DirectionKind" }],
    references: [],
  },
  {
    id: "DriverField",
    ...
    stereotype: "EClass",
    description:
      "Semantic field representing a driver or explanatory variable.",
    attributes: [{ name: "expectedEffect", type: "DirectionKind" }],
    references: [],
  },
  {
    id: "ScenarioModel",
    ...
    stereotype: "EClass",
    description:
      "Container for assumptions and evidence that contextualize forecast changes.",
    attributes: [],
    references: [
      {
        name: "assumptions",
        target: "AssumptionElement",
        lowerBound: 0,
        upperBound: "*",
        containment: true,
      },
  ...
  },
  {
    ...
    abstract: true,
    description:
      "Abstract superclass for scenario assumptions and domain-specific assumptions.",
    attributes: [
  ...
  },
  {
    ...
    attributes: [{ name: "statement", type: "EString" }],
    references: [],
  },
  {
    ...
    stereotype: "EClass",
    description:
      "Use-case-specific assumption representing planned or committed AI data-center load.",
    attributes: [
  ...
  },
  {
    ...
    stereotype: "EClass",
    description:
      "Evidence used to support assumptions, confidence signals, or decision recommendations.",
    attributes: [
  ...
  },
  {
    ...
    attributes: [{ name: "largeVarianceThreshold", type: "EDouble" }],
    references: [],
  },
  {
    id: "VolatilityMethod",
    ...
    attributes: [{ name: "highVolatilityThreshold", type: "EDouble" }],
    references: [],
  },
  {
    id: "ConfidenceMethod",
    ...
    attributes: [{ name: "confidenceRule", type: "EString" }],
    references: [],
  },
  {
    ...
    stereotype: "EClass",
    description:
      "Derived model comparing baseline and current forecasts over the same selected horizon.",
    attributes: [
    ...
    references: [
      {
        name: "records",
        target: "ForecastComparisonRecord",
        lowerBound: 1,
        upperBound: "*",
        containment: true,
      },
  ...
  },
  {
    ...
    stereotype: "EClass",
    description:
      "Paired baseline and current forecast value for one target and period.",
    attributes: [
  ...
  },
  {
    ...
    attributes: [{ name: "variancePct", type: "EDouble" }],
    references: [],
  },
  {
    id: "VolatilitySignal",
    ...
    stereotype: "EClass",
    description:
      "Signal representing instability across forecast revisions or drivers.",
    attributes: [{ name: "volatilityScore", type: "EDouble" }],
    references: [],
  },
  {
    id: "ConfidenceSignal",
    ...
    stereotype: "EClass",
    description:
      "Signal representing confidence in the forecast change interpretation.",
    attributes: [{ name: "confidenceLevel", type: "ConfidenceKind" }],
    references: [
      {
        name: "supportedBy",
        target: "EvidenceArtifact",
  ...
  },
  {
    ...
    stereotype: "EClass",
    description:
      "Policy mapping signal patterns to actionability recommendations.",
  ...
  },
  {
    ...
    stereotype: "EClass",
    description:
      "Rule that maps variance, volatility, and confidence patterns to an action.",
    attributes: [
  ...
  },
  {
    ...
    stereotype: "EClass",
    description:
      "Decision-facing interpretation of forecast change for one target.",
    attributes: [
...
export const INHERITANCE_EDGES: MetaEdge[] = [
  {
    source: "ForecastAssuranceProject",
    target: "ModelElement",
    label: "extends",
  },
  ...
  {
    source: "ForecastComparisonModel",
    target: "ModelElement",
    label: "extends",
  },
  ...
  {
    source: "ScenarioAssumption",
    target: "AssumptionElement",
    label: "extends",
  },
  {
    source: "DataCenterCommitment",
    target: "AssumptionElement",
    label: "extends",
  },
...
export const COMPOSITION_AND_ASSOCIATION_EDGES: MetaEdge[] =
  CORE_METACLASSES.flatMap((meta) =>
...
export const PALETTE_TEMPLATES: PaletteTemplate[] = [
  {
    ...
    description:
      "A use-case-specific business entity, such as customer segment, facility, route, or load source.",
    attributes: [
      { name: "name", type: "EString" },
      { name: "description", type: "EString" },
    ],
  ...
  },
  {
    ...
    description:
      "A constraint that may limit or condition a forecast-based decision.",
    attributes: [
      { name: "name", type: "EString" },
  ...
  },
  {
    ...
    description:
      "A domain-specific decision that is informed by a ForeACT decision card.",
    attributes: [
      { name: "name", type: "EString" },
  ...
  },
  {
    ...
    description:
      "A domain-specific evidence artifact that supports assumptions, confidence, or recommendations.",
    attributes: [
  ...
  },
  {
    ...
    description:
      "A planned or committed data-center load that affects electricity demand forecasts.",
    attributes: [
  ...
  return {
    ...
    data: {
      ...
      references: meta.references.map(
        (r) =>
          `${r.name}: ${r.target} [${r.lowerBound ?? 0}..${r.upperBound ?? "*"}]`,
      ),
      isCore: true,
...
export function buildMetamodelFlow(
  concepts: CustomConcept[],
  extensionEdges: MetaEdge[],
) {
  ...
  const customEdges = extensionEdges.map((edge, idx) =>
    edgeToFlow(edge, idx + CORE_EDGES.length),
  );
