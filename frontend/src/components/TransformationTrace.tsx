...
export function TransformationTrace({
  analysis,
}: {
    ...
    <section className="panel">
      <div className="panel-header">
        <div>
          ...
          <p className="muted">
            These transformations are the main model-driven mechanism: raw data
            is transformed into semantic models, forecast comparison models,
            signal models, and decision models.
          </p>
        </div>
      </div>
      ...
      {(analysis.warnings || []).length > 0 && (
        <p className="muted">
          <b>Warnings:</b> {(analysis.warnings || []).join("; ")}
        </p>
      )}
    </section>
  );
