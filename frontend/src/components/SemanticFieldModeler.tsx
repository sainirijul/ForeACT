...
export function SemanticFieldModeler({
  profile,
  fieldSpecs,
  setFieldSpecs,
}: Props) {
    ...
    <section className="panel">
      <div className="panel-header split">
        <div>
          ...
          <p className="muted">
            Auto-discovered fields are only a starting point. Modelers make the
            dataset interpretable by assigning roles, units, semantic types, and
            business meaning.
          </p>
        </div>
              ...
              <tr key={field.name}>
                <td>
                  <input
                    ...
                    onChange={(e) =>
                      update(index, { include_in_model: e.target.checked })
                    }
                  />
                </td>
                <td>
                ...
                <td>
                  <input
                    ...
                    onChange={(e) =>
                      update(index, { business_name: e.target.value })
                    }
                  />
                </td>
                <td>
                ...
                <td>
                  <select
                    ...
                    onChange={(e) =>
                      update(index, { semantic_type: e.target.value })
                    }
                  >
                ...
                <td>
                  <select
                    ...
                    onChange={(e) =>
                      update(index, { direction: e.target.value })
                    }
                  >
