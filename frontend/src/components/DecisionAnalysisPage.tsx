    ...
    return (
      <section className="page-grid">
        <article className="panel hero-panel full-span">
          ...
          <p>
            This page consumes the compiled SignalModel and DecisionPolicy. It
            remains empty until the model transformations produce
            revision-magnitude and volatility signals.
          </p>
  ...
  return (
    <section className="page-grid">
      <article className="panel hero-panel full-span">
        ...
        <p>
          This page is intentionally after the modeling pages. It visualizes
          only the signals produced from the explicit project specification and
      ...
      <div className="full-span">
        <MatrixPlot
          points={analysis.matrix_points}
          methods={analysis.dataset_profile.selected_methods}
          policy={policy}
        />
      </div>
      <div className="full-span">
        <DecisionCards cards={analysis.decision_cards} />
      </div>
      <div className="full-span">
        <SignalInsights results={analysis.target_results} />
      </div>
      <article className="panel full-span">
