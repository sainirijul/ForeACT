...
const connectionOptions = ['DatasetVersion', 'FieldModel', 'ScenarioModel', 'MethodSet', 'ForecastComparisonModel', 'SignalModel', 'DecisionModel', 'AssumptionElement', 'EvidenceArtifact', 'TargetField'];
